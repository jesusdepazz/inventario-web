...
const HojaResponsabilidad = () => {
    ...
    const handleAgregarEmpleado = async () => {
        ...
        try {
            const res = await axios.get(`https://inveq-test.guandy.com/api/empleados/${codigoEmpleado}`);
    ...
    const HandleAgregarEquipo = async () => {
        ...
        try {
            const res = await fetch(`https://inveq-test.guandy.com/api/equipos/por-codificacion/${codEquipo}`);
